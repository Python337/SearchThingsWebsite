...
@app.route('/shovel')
def shovel():
    return redirect('https://market.yandex.ru/product--solid-1026684'
...
@app.route('/screen')
def screen():
    return redirect('https://market.yandex.ru/product--27-monitor-27-lg-27gs60f-b-'
...
@app.route('/plate')
def plate():
    return redirect('https://www.muztorg.ru/produсt/A096552?utm_source=yd&utm_medium'
...
@app.route('/mouse_pad')
def mouse_pad():
    return redirect('https://www.wildberries.ru/catalog/133030253/detail.aspx')


@app.route('/screwdriver')
def screwdriver():
    return redirect('https://market.yandex.ru/product--gsb-180-li-601-9f8-323/'
